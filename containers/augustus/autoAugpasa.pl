...
sub construct_training_set{
    ...
    my $pasaDBname = "sample_mydb_pasa.sqlite";
    ...
    $perlCmdString = "Launch_PASA_pipeline.pl "
        ."-c /usr/local/src/PASApipeline/sample_data/sqlite.confs/alignAssembly.config -C -R -g /data/genome.fa "
        ."-t /data/transcripts.fasta --ALIGNER gmap --CPU $cpus "
